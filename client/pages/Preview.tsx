        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              <span className="text-xs font-medium text-gray-900">Form builder</span>
            </div>
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="w-83 bg-white border-r border-gray-200 flex flex-col">
          <div className="p-4 space-y-2">
            ...
            >
              <h3 className="font-bold text-sm text-gray-900">Receiver's View</h3>
              <p className="text-xs text-gray-500 mt-1">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
              </p>
            </div>
        ...
        <div className="flex-1 p-6 bg-white overflow-auto">
          <div className="max-w-4xl mx-auto space-y-6">
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dob" className="text-xs font-medium text-gray-900">
                        Date Of Birth
                      </Label>
                      <Input
                        id="dob"
            ...
            <Card className="border border-gray-200">
              <div className="p-4 border-b border-gray-200">
                <h2 className="text-base font-bold text-gray-900 mb-1">Document Verification</h2>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  {/* User Upload Options */}
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">User Upload Options</h3>
                    ...
                    <div className="bg-gray-50 rounded p-6 space-y-5">
                      <div className="flex items-start gap-2 pb-5 border-b border-gray-200">
                        ...
                        <div className="flex-1">
                          <h4 className="text-xs font-medium text-gray-900 mb-1">Allow Upload from Device</h4>
                          <p className="text-xs text-gray-500">Let users upload existing documents directly from their device.</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          <h4 className="text-xs font-medium text-gray-900 mb-1">Allow Capture via Webcam</h4>
                          <p className="text-xs text-gray-500">Enable webcam access to allow users to capture documents in real time.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Unreadable Document Handling</h3>
                    <p className="text-xs text-gray-900 mb-4">
                    ...
                    <div className="bg-gray-50 rounded p-6">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          <h4 className="text-xs font-medium text-gray-900 mb-1">Allow Retries Before Rejection</h4>
                          <p className="text-xs text-gray-500">Let users reattempt uploading the document before it's finally rejected.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Supported Countries */}
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Supported Countries for Identity Verification</h3>
                    <p className="text-xs text-gray-900 mb-4">
                      Only document from these countries are supported.
                    </p>
                    <div className="bg-gray-50 rounded p-6">
                      <div className="mb-2">
                        <Label className="text-xs font-medium text-gray-900">Which countries are supported?</Label>
                      </div>
                      <div className="bg-white rounded-lg p-3">
                        ...
                        <div className="flex flex-wrap gap-2 p-3 bg-white rounded-lg">
                          <Badge variant="secondary" className="h-8 rounded-full border border-gray-300 bg-gray-50">
            ...
            <Card className="border border-gray-200">
              <div className="p-4 border-b border-gray-200">
                <h2 className="text-base font-bold text-gray-900 mb-1">Biometric Verification</h2>
                <p className="text-xs text-gray-900">
              ...
              <CardContent className="p-4">
                <div className="space-y-6">
                  {/* Retry Attempts */}
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Retry Attempts for Selfie Capture</h3>
                    <p className="text-xs text-gray-900 mb-4">
                      Define how many times a user can retry if the selfie capture fails.
                    </p>
                    <div className="bg-gray-50 rounded p-6">
                      <div className="flex items-center justify-between">
                        <Label className="text-xs font-medium text-gray-900">Set the maximum number of retries</Label>
                        <div className="w-80">
                          <Input
                            value="4"
                  ...
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Liveness Confidence Threshold (%)</h3>
                    <p className="text-xs text-gray-900 mb-4">
                    ...
                    <div className="bg-gray-50 rounded p-6">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          <h4 className="text-xs font-medium text-gray-900 mb-1">Ask the user to try again</h4>
                          <p className="text-xs text-gray-500">Prompt the user to reattempt the selfie.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Biometric Data Retention</h3>
                    <p className="text-xs text-gray-900 mb-4">
                      Choose whether to store biometric/selfie data and define retention duration.
                    </p>
                    <div className="bg-gray-50 rounded p-6">
                      <div className="flex items-center justify-between">
                        <Label className="text-xs font-medium text-gray-900">Enable biometric data storage</Label>
                        <div className="w-80">
                          <Input
                            value="6 Months"
