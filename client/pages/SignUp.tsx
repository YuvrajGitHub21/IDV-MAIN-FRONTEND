      ...
      <div className="relative hidden lg:block lg:w-1/2 bg-white overflow-hidden">
        <div className="absolute inset-0">
          <div
            ...
            style={{ background: "#BCD2E8", filter: "blur(115px)", left: "335px", top: "301px" }}
          />
          <div
            className="absolute w-[465px] h-[397px] rounded-full opacity-80"
            style={{ background: "#E0EFFE", filter: "blur(80px)", left: "0px", top: "0px" }}
          />
        </div>
        ...
        <div className="relative z-10">
          <div
            ...
            style={{ left: "190px", top: "214px", transform: "rotate(-12.392deg)" }}
          >
            <div
              className="absolute w-full h-full rounded-full"
              style={{ background: "linear-gradient(135deg, #F8E4E8 0%, #E0EFFE 100%)", filter: "blur(34px)" }}
            />
          </div>
          ...
          <div className="absolute" style={{ left: "275px", top: "140px" }}>
            <div
              ...
              style={{ background: "linear-gradient(324deg, #E0EFFE 19.3%, #F3CFFF 70.5%)", backdropFilter: "blur(7.5px)", transform: "rotate(6.554deg)" }}
            />

            <div className="absolute w-[252px] h-[318px] rounded-3xl border border-black/10 bg-white" style={{ left: "1px", top: "10px", backdropFilter: "blur(7.5px)" }}>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-16 bg-white relative">
        <div className="relative z-10 max-w-[360px] md:max-w-[420px] mx-auto w-full">
          ...
          <div className="text-center mb-6 md:mb-8">
            <h1 className="text-arcon-gray-heading text-2xl md:text-3xl font-bold font-roboto mb-2">Sign up</h1>
            <p className="text-arcon-gray-secondary text-sm font-roboto">Create your account with email and password.</p>
          </div>

          {/* Form Content */}
          <div className="space-y-5 sm:space-y-6 md:space-y-7">
            <div>
              <label className="block text-arcon-gray-primary text-sm md:text-sm font-medium mb-2 font-roboto">First Name</label>
              ...
              {errors.firstName && <p className="text-red-500 text-xs sm:text-sm mt-1 font-roboto">{errors.firstName}</p>}
            </div>

            <div>
              <label className="block text-arcon-gray-primary text-sm md:text-sm font-medium mb-2 font-roboto">Last Name</label>
              <div className="relative">
                <input
                  type="text"
                  name="lastName"
              ...
              {errors.lastName && <p className="text-red-500 text-xs sm:text-sm mt-1 font-roboto">{errors.lastName}</p>}
            </div>

            <div>
              <label className="block text-arcon-gray-primary text-sm md:text-sm font-medium mb-2 font-roboto">Email Address</label>
              <div className="relative">
                <input
                  type="email"
                  name="email"
              ...
              {errors.email && <p className="text-red-500 text-xs sm:text-sm mt-1 font-roboto">{errors.email}</p>}
            </div>

            <div>
              <label className="block text-arcon-gray-primary text-sm md:text-sm font-medium mb-2 font-roboto">Password</label>
              <div className="relative">
                <input
                  type="password"
                  name="password"
              ...
              {errors.password && <p className="text-red-500 text-xs sm:text-sm mt-1 font-roboto">{errors.password}</p>}
            </div>

            <div>
              <label className="block text-arcon-gray-primary text-sm md:text-sm font-medium mb-2 font-roboto">Confirm Password</label>
              <div className="relative">
                <input
                  type="password"
              ...
              {errors.confirmPassword && (
                <p className="text-red-500 text-xs sm:text-sm mt-1 font-roboto">{errors.confirmPassword}</p>
              )}
            </div>

            {errors.submit && <div className="text-red-500 text-xs sm:text-sm text-center font-roboto">{errors.submit}</div>}
          ...
          <div className="text-center mt-6">
            <p className="text-arcon-gray-secondary text-xs sm:text-sm font-roboto">
              ...
              <button onClick={() => navigate("/login", { replace: true })} className="text-arcon-blue hover:underline font-medium">
                Log in
              </button>
            </p>
          </div>
