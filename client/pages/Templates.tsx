...
export default function Templates() {
  ...
  const [sendInviteTemplateId, setSendInviteTemplateId] = useState<
    string | null
  >(null);

  // send invite dialog state
  const [inviteVersionId, setInviteVersionId] = useState<number | undefined>(
    undefined,
  );
  ...
  const resolveVersionIdForTemplate = (tpl: any): number | undefined => {
    ...
    if (
      typeof tpl?.currentVersion === "number" &&
      Number.isFinite(tpl.currentVersion)
    ) {
