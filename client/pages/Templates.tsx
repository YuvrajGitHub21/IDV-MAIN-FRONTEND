          ...
          <div className="relative flex flex-col h-full pt-2 pb-4 z-50">
            <nav className="flex-1 px-0 space-y-1">
              ...
              <div className="flex flex-col items-center py-2 text-gray-600 hover:bg-gray-50 cursor-pointer">
                <svg className="w-5 h-5" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col items-center py-2 text-gray-600 hover:bg-gray-50 cursor-pointer">
                <svg className="w-5 h-5" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.1654 9.16536H1.83203M10.082 12.832H5.4987M1.83203 7.51536V14.482C1.83203 15.5088 1.83203 16.0222 2.03186 16.4144C2.20762 16.7593 2.48808 17.0398 2.83305 17.2155C3.22522 17.4154 3.7386 17.4154 4.76536 17.4154H17.232C18.2588 17.4154 18.7722 17.4154 19.1644 17.2155C19.5093 17.0398 19.7898 16.7593 19.9655 16.4144C20.1654 16.0222 20.1654 15.5088 20.1654 14.482V7.51536C20.1654 6.48861 20.1654 5.97522 19.9655 5.58305C19.7898 5.23809 19.5093 4.95763 19.1644 4.78186C18.7722 4.58203 18.2588 4.58203 17.232 4.58203H4.76536C3.73861 4.58203 3.22522 4.58203 2.83305 4.78186C2.48809 4.95762 2.20762 5.23808 2.03186 5.58305C1.83203 5.97522 1.83203 6.4886 1.83203 7.51536Z" stroke="#676879" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            ...
            <div className="flex flex-col items-center py-2 text-gray-600 hover:bg-gray-50 cursor-pointer">
              <svg className="w-5 h-5" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.3312 8.2487C8.54671 7.63606 8.97209 7.11947 9.53203 6.7904C10.0919 6.46134 10.7502 6.34106 11.3903 6.45085C12.0304 6.56065 12.6109 6.89342 13.0292 7.39027C13.4474 7.8871 13.6764 8.51592 13.6754 9.16536C13.6754 10.9987 10.9254 11.9154 10.9254 11.9154M10.9987 15.582H11.0079M20.1654 10.9987C20.1654 16.0613 16.0613 20.1654 10.9987 20.1654C5.93609 20.1654 1.83203 16.0613 1.83203 10.9987C1.83203 5.93609 5.93609 1.83203 10.9987 1.83203C16.0613 1.83203 20.1654 5.93609 20.1654 10.9987Z" stroke="#676879" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
